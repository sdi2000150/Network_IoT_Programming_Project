...
public class BaseActivity extends AppCompatActivity {
    ...
    protected void requestBackgroundLocationPermission() {
        new AlertDialog.Builder(this)
                ...
                .setMessage("To continue using the device's location features, please grant background location access.\nUserApp will continue sending messages in the background after providing permissions.")
